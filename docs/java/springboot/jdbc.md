...
![1574409852703](assets/1574409852703.png)
...
![1574411869052](assets/1574411869052.png)

![1574412098885](assets/1574412098885.png)

上面方法也不知道在干什么，反正就是只要是`NEVER`和`EMBEDDED`就为true，而DataSourceInitializationMode枚举类中除了这两个就剩下`ALWAYS`了，可以在配置文件中配置为ALWAYS

![1574412237660](assets/1574412237660.png)
