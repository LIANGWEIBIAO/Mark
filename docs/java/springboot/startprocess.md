...
![1574497298469](assets/1574497298469.png)
...
2. 创建SpringApplication
   ...
   ![1574503716694](assets/1574503716694.png)
   ...
   ![1574502740682](assets/1574502740682.png)
...
3. 调用SpringApplication对象的run方法
   ...
   ![1574512218795](assets/1574512218795.png)
...
1. 创建`ApplicationContextInitializer`和`SpringApplicationRunListener`的实现类，并在META-INF/spring.factories文件中配置
   ...
   ![1574515721669](assets/1574515721669.png)
...
2. 创建`ApplicationRunner`实现类和`CommandLineRunner`实现类，注入到容器中
   ...
   ![1574517578711](assets/1574517578711.png)
...
![1574508283758](assets/1574508283758.png)
