...
![img](https://www.funtl.com/assets/git-workflow-svn-initialize.png)
...
![img](https://www.funtl.com/assets/git-workflow-svn-clone.png)
...
![img](https://www.funtl.com/assets/git-workflow-svn-1.png)
...
![img](https://www.funtl.com/assets/git-workflow-svn-2.png)
...
![img](https://www.funtl.com/assets/git-workflow-svn-3.png)
...
![img](https://www.funtl.com/assets/git-workflow-svn-4.png)
...
![img](https://www.funtl.com/assets/git-workflow-svn-5.png)
...
![img](https://www.funtl.com/assets/git-workflow-svn-6.png)

如果你忘加了这个选项，pull 操作仍然可以完成，但每次 pull 操作要同步中央仓库中别人修改时，提交历史会以一个多余的『合并提交』结尾。对于集中式工作流，最好是使用 rebase 而不是生成一个合并提



### 小红解决合并冲突

![img](https://www.funtl.com/assets/git-workflow-svn-7.png)
...
![img](https://www.funtl.com/assets/git-workflow-svn-8.png)
...
![img](https://www.funtl.com/assets/git-workflow-svn-9.png)
