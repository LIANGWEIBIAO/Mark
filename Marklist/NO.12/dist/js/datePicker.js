...
detePicker.prototype = {
    getMonthDate: function (year, month) {//获取日期数据
        var ret = [];
    ...
    rander: function (monthChange) { //重新渲染
        var year, month;
    ...
    buildUi: function (year, month) { //渲染模版
